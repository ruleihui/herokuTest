...
fclone copy ssl:{10p6gvNkHhFmhGIsCIV7LYJImyzTq7OsD} ssl:{0AFLoarsGwGcIUk9PVA}baidu --drive-server-side-across-configs --stats=3s --stats-one-line  -vP  --transfers=500 --checkers=300 --drive-pacer-min-sleep=1ms --check-first --ignore-existing --max-transfer=700G   &
echo $!>currentPid
